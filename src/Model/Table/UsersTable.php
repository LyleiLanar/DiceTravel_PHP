 ...
 * @property \App\Model\Table\JourneysTable&\Cake\ORM\Association\HasMany $Journeys
 *
...
class UsersTable extends Table
{
    ...
    {
        $rules->add($rules->isUnique(['login_name']), ['errorField' => 'login_name']);
